...
public class RunMatsim8 {
    ...
    public static void main(String[] args) {
        ...
        config.controler().setOutputDirectory("output/problem2/with8");
        ...
        config.network().setInputFile("link8Network.xml");
...
//		controler.addOverridingModule( new OTFVisLiveModule() ) ;
        ...
        controler.run();
        new ConfigWriter(config).write("scenarios/final/problem2/configwith8.xml");
    }
