...
public class PopGeneratorDRT {
        ...
        private static final String OUTPUT_FILE = "./scenarios/final/ebersberg/drtPopulation.xml";
        private static final double SCALE_FACTOR = 0.1;
        private static final double MODE_SPLIT_CAR = 1;
