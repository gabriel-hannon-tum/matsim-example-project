...
public class RandomDemandGeneratorExercise {
    ...
    private static final String ZONE_FILE = "./scenarios/week4/georef-germany-kreis/georef-germany-kreis-millesime.shp";
    ...
    private static final double ptMode = 0.35;
    ...
    public static void main(String[] args) {
        ...
        createOD(471859, "09162", "09162", "Munich-Munich"); //471859
    ...
    private static void createOD(int commuter, String origin, String destination, String odPrefix) {
        ...
        int scaledCommuter = (int) (commuter * scale);
