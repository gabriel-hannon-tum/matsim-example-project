...
public class RunHolzkirchen {
    ...
    public static void main(String[] args) {
        ...
        config.network().setInputFile("scenarios/holzkirchen/network.xml");
        config.plans().setInputFile("scenarios/holzkirchen/plans_prepared.xml");
        ...
        drtConfig.setVehiclesFile("scenarios/holzkirchen/drtFleet.xml.gz");
